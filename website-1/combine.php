...
<html lang="en">
<head>
  <!-- Theme Made By Jakso - No Copyright -->
  <title>Alan Theme</title>
  <meta charset="utf-8">
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60" onscroll="myFunction()">

  	<nav class="navbar navbar-default navbar-fixed-top" id="hellos">
  		<div class="container">
	  ...
	  <div class="row">
	    ...
	    <div class="col-sm-8">
	      ...
	      <br><button class="btn btn-default btn-lg">Keep in touch</button>
	    </div>
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
  	...
  	<div class="height-3 width-100 text-center" id="force" onmouseover="rocket(this);" >
  		<h1>force</h1>
  	</div>
  	
  	<script type="text/javascript">
  	
  	//var nice = document.getElementById('force');
	var div = document.getElementById( 'hellos' );
  		
  		function rocket(x){
  			// below is on mouse over
  			x.style.backgroundColor = 'red';
 			
 			// javascript allow to put function within function
